...
iptables -t nat -A PREROUTING -p tcp --dport 30001 -j DNAT --to-destination 51.195.25.89:30001
...
iptables -t nat -A PREROUTING -p udp --dport 443 -j DNAT --to-destination 51.195.25.89:443
